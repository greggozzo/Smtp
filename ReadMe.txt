...
To use credentials downloaded from SES in .csv file, specify the path of the file.
...
Credentials for the delegate sender(sending account), must match the region of the identity ARN you are using from the Identity owner account.
